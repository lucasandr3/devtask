<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('configuracoes.index') }}" class="btn-secondary text-sm">
        ...
        <div class="card">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Suas Contas de Email</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Gerencie suas contas de email para enviar e receber mensagens</p>
                        </div>
                    </div>
            ...
            @if($accounts->isEmpty())
                <div class="p-12 text-center">
                    ...
                    <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Nenhuma conta configurada</h4>
                    <p class="text-gray-500 dark:text-gray-400 mb-4">Adicione uma conta de email para começar a enviar e receber mensagens.</p>
                    <button @click="showAddModal = true" class="btn-primary">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
            ...
            @else
                <div class="divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach($accounts as $account)
                        <div class="p-4 sm:p-6 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="w-12 h-12 rounded-xl flex items-center justify-center
                                    ...
                                    @elseif($account->provider === 'icloud') bg-gray-100 dark:bg-gray-700
                                ...
                                <div>
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if($account->is_default)
                                            <span class="px-2 py-0.5 text-xs font-medium bg-primary-100 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300 rounded-full">
                                                Padrão
                                            </span>
                                        @endif
                                        @if(!$account->is_active)
                                            <span class="px-2 py-0.5 text-xs font-medium bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400 rounded-full">
                                                Inativo
                                            </span>
                                        @endif
                                    </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <form action="{{ route('configuracoes.emails.sync', $account) }}" method="POST" class="inline">
                                    @csrf
                                    <button type="submit" class="p-2 text-gray-400 hover:text-green-600 dark:hover:text-green-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" title="Sincronizar emails">
                                ...
                                @if(!$account->is_default)
                                    <form action="{{ route('configuracoes.emails.default', $account) }}" method="POST" class="inline">
                                        @csrf
                                        <button type="submit" class="p-2 text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" title="Definir como padrão">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('configuracoes.emails.edit', $account) }}" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" title="Editar">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                </a>

                                <form action="{{ route('configuracoes.emails.destroy', $account) }}" method="POST" class="inline" onsubmit="return confirm('Tem certeza que deseja excluir esta conta?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="p-2 text-gray-400 hover:text-red-600 dark:hover:text-red-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" title="Excluir">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                    <form action="{{ route('configuracoes.emails.store') }}" method="POST">
                        ...
                        <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Adicionar Conta de Email</h3>
                            <button type="button" @click="showAddModal = false" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="p-6 space-y-6 max-h-[60vh] overflow-y-auto">
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="number" name="smtp_port" :value="getConfig('smtp_port')" class="input text-sm">
                                            </div>
                                            <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="number" name="imap_port" :value="getConfig('imap_port')" class="input text-sm">
                                            </div>
                                            <div>
                            ...
                            <label class="flex items-center gap-3 cursor-pointer">
                                <input type="checkbox" name="is_default" value="1" class="w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Definir como conta padrão</span>
                            </label>
                        </div>
