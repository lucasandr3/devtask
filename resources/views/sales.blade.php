...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    <head>
        ...
        <meta name="description" content="DevTask - Sistema completo de gestão de tarefas, controle de horas e relatórios para desenvolvedores">

        <title>{{ config('app.name', 'DevTask') }} - Sistema de Gestão para Desenvolvedores</title>
    ...
    <body class="font-sans antialiased bg-gray-50 dark:bg-slate-950 text-gray-900 dark:text-white overflow-x-hidden">
                ...
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="relative">
                            ...
                            <div class="relative p-2.5 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl shadow-lg">
                        ...
                        <span class="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
                            {{ config('app.name', 'DevTask') }}
                        </span>
                    </div>

                    <!-- Nav Links (Desktop) -->
                    <div class="hidden md:flex items-center gap-8">
                        <a href="#features" class="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            Recursos
                        </a>
                        <a href="#how-it-works" class="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            Como Funciona
                        </a>
                        <a href="#testimonials" class="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            Depoimentos
                        </a>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        <!-- Dark Mode Toggle -->
                        <button onclick="toggleDarkMode()" class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors">
                        ...
                        @else
                            <a href="{{ route('entrar') }}" class="hidden sm:inline-flex text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                Entrar
                            </a>
                ...
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div class="text-center lg:text-left">
                        ...
                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800 rounded-full mb-8">
                            ...
                            <span class="text-sm font-medium text-blue-700 dark:text-blue-300">Sistema completo para devs</span>
                        </div>

                        <!-- Headline -->
                        <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
                            <span class="text-gray-900 dark:text-white">Gerencie seu trabalho</span>
                            <br>
                        ...
                        <!-- Subheadline -->
                        <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-xl mx-auto lg:mx-0">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
                            ...
                            @else
                                ...
                                <a href="{{ route('entrar') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white dark:bg-slate-800 text-gray-900 dark:text-white text-lg font-semibold rounded-2xl border-2 border-gray-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-500 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="flex items-center justify-center lg:justify-start gap-6">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">Usado por <span class="font-semibold text-gray-900 dark:text-white">50+</span> desenvolvedores</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            <!-- Main Dashboard Card -->
                            <div class="glass-card rounded-3xl border border-gray-200/50 dark:border-slate-700/50 shadow-2xl p-6 transform hover:scale-[1.02] transition-transform duration-500">
                                <!-- Header -->
                                <div class="flex items-center justify-between mb-6">
                                    <div>
                                        <h3 class="text-lg font-bold text-gray-900 dark:text-white">Dashboard</h3>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Visão geral do seu dia</p>
                                    </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-6">
                                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/50 dark:to-blue-900/30 rounded-2xl p-4">
                                        ...
                                        <p class="text-xs text-gray-600 dark:text-gray-400">Tarefas ativas</p>
                                    </div>
                                    <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/50 dark:to-green-900/30 rounded-2xl p-4">
                                        <div class="flex items-center gap-3 mb-2">
                                            ...
                                            <span class="text-2xl font-bold text-gray-900 dark:text-white">8h</span>
                                        </div>
                                        <p class="text-xs text-gray-600 dark:text-gray-400">Horas trabalhadas</p>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-slate-800/50 rounded-xl">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-900 dark:text-white">Implementar API REST</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">Em progresso</p>
                                        </div>
                                    ...
                                    <div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-slate-800/50 rounded-xl">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-900 dark:text-white">Code Review PR #42</p>
                            ...
                            <div class="absolute -top-4 -right-4 glass-card rounded-2xl border border-gray-200/50 dark:border-slate-700/50 shadow-xl p-4 animate-float-delayed">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white">Hora registrada!</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Entrada às 09:00</p>
                                    </div>
                                </div>
                            </div>

                            <!-- Floating Stats Card -->
                            <div class="absolute -bottom-4 -left-4 glass-card rounded-2xl border border-gray-200/50 dark:border-slate-700/50 shadow-xl p-4 animate-float">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Produtividade este mês</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Features Section -->
        <section id="features" class="py-24 sm:py-32 bg-white dark:bg-slate-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Section Header -->
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="group relative reveal">
                        ...
                        <div class="relative h-full bg-gray-50 dark:bg-slate-800 rounded-3xl p-8 border border-gray-100 dark:border-slate-700 hover:border-blue-500/50 dark:hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-2">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Gestão de Tarefas</h3>
                    ...
                    <div class="group relative reveal" style="transition-delay: 100ms;">
                        ...
                        <div class="relative h-full bg-gray-50 dark:bg-slate-800 rounded-3xl p-8 border border-gray-100 dark:border-slate-700 hover:border-green-500/50 dark:hover:border-green-500/50 transition-all duration-500 hover:-translate-y-2">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Controle de Horas</h3>
                            <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <div class="group relative reveal" style="transition-delay: 200ms;">
                        ...
                        <div class="relative h-full bg-gray-50 dark:bg-slate-800 rounded-3xl p-8 border border-gray-100 dark:border-slate-700 hover:border-purple-500/50 dark:hover:border-purple-500/50 transition-all duration-500 hover:-translate-y-2">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Relatórios Mensais</h3>
                            <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <div class="group relative reveal" style="transition-delay: 300ms;">
                        ...
                        <div class="relative h-full bg-gray-50 dark:bg-slate-800 rounded-3xl p-8 border border-gray-100 dark:border-slate-700 hover:border-orange-500/50 dark:hover:border-orange-500/50 transition-all duration-500 hover:-translate-y-2">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Pull Requests</h3>
                            <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <section id="how-it-works" class="py-24 sm:py-32 bg-gray-50 dark:bg-slate-950">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Section Header -->
                <div class="text-center mb-20 reveal">
                    <span class="inline-block px-4 py-2 bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 text-sm font-semibold rounded-full mb-4">
                ...
                <div class="grid md:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div class="relative reveal">
                        <div class="text-center">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Crie sua conta</h3>
                    ...
                    <div class="relative reveal" style="transition-delay: 150ms;">
                        <div class="text-center">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Configure seu contrato</h3>
                            <p class="text-gray-600 dark:text-gray-400">
                    ...
                    <div class="relative reveal" style="transition-delay: 300ms;">
                        <div class="text-center">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Comece a gerenciar</h3>
                            <p class="text-gray-600 dark:text-gray-400">
        ...
        <section id="testimonials" class="py-24 sm:py-32 bg-white dark:bg-slate-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Section Header -->
                <div class="text-center mb-20 reveal">
                    <span class="inline-block px-4 py-2 bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 text-sm font-semibold rounded-full mb-4">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <!-- Testimonial 1 -->
                    <div class="reveal">
                        <div class="h-full glass-card rounded-3xl p-8 border border-gray-200/50 dark:border-slate-700/50 hover:shadow-xl transition-shadow duration-500">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                                "O DevTask revolucionou minha forma de trabalhar. Agora tenho controle total sobre minhas horas e tarefas. Os relatórios mensais são perfeitos!"
                            </p>
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900 dark:text-white">João Dev</p>
                    ...
                    <div class="reveal" style="transition-delay: 100ms;">
                        <div class="h-full glass-card rounded-3xl p-8 border border-gray-200/50 dark:border-slate-700/50 hover:shadow-xl transition-shadow duration-500">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900 dark:text-white">Ana Silva</p>
                    ...
                    <div class="reveal" style="transition-delay: 200ms;">
                        <div class="h-full glass-card rounded-3xl p-8 border border-gray-200/50 dark:border-slate-700/50 hover:shadow-xl transition-shadow duration-500">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                                "Interface limpa, funcionalidades completas e fácil de usar. O DevTask se tornou essencial no meu dia a dia como desenvolvedor."
                            </p>
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900 dark:text-white">Marcos Reis</p>
        ...
        <section class="relative py-24 sm:py-32 overflow-hidden">
            ...
            <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
                ...
                <p class="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
                    Junte-se a dezenas de desenvolvedores que já estão gerenciando seu trabalho de forma mais inteligente com o DevTask.
                </p>
                ...
                <div class="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <span class="text-xl font-bold text-white">{{ config('app.name', 'DevTask') }}</span>
                        </div>
                ...
                <div class="pt-8 border-t border-gray-800">
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p class="text-gray-500 text-sm">
                            &copy; {{ date('Y') }} {{ config('app.name', 'DevTask') }}. Todos os direitos reservados.
                        </p>
                        <div class="flex items-center gap-4">
        ...
        <script>
            ...
            function toggleDarkMode() {
                ...
                localStorage.setItem('devtask-dark-mode', isDark);
            }
            ...
            window.addEventListener('scroll', () => {
                if (window.scrollY > 50) {
                    navbar.classList.add('bg-white/90', 'dark:bg-slate-900/90', 'backdrop-blur-lg', 'shadow-lg');
                } else {
                    navbar.classList.remove('bg-white/90', 'dark:bg-slate-900/90', 'backdrop-blur-lg', 'shadow-lg');
                }
            });
