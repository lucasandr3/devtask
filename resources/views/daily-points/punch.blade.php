<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col justify-between">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $today->format('d/m/Y') }}</p>
        </div>
    </x-slot>
                ...
                <div class="card p-6 h-full">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
                            <span class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Entrada</span>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                                {{ $point && $point->entry_time ? $point->entry_time->format('H:i') : '--:--' }}
                            </p>
                        </div>
                        <div class="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
                            <span class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Saída Almoço</span>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                                {{ $point && $point->lunch_out_time ? $point->lunch_out_time->format('H:i') : '--:--' }}
                            </p>
                        </div>
                        <div class="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
                            <span class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Volta Almoço</span>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                                {{ $point && $point->lunch_return_time ? $point->lunch_return_time->format('H:i') : '--:--' }}
                            </p>
                        </div>
                        <div class="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
                            <span class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Saída</span>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                    ...
                    <div class="pt-6 border-t border-gray-200 dark:border-slate-700">
                        <div class="flex items-center justify-between">
                            <span class="text-gray-600 dark:text-gray-400">Total trabalhado:</span>
                    ...
                    <div class="flex-1 flex flex-col justify-center">
                        ...
                        @else
                            <div class="flex flex-col items-center text-center">
                                ...
                                <p class="text-gray-600 dark:text-gray-400 mb-6">Todas as horas foram registradas.</p>
                                
                                <a href="{{ route('horas.index') }}" class="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-gray-200 dark:bg-slate-700 text-gray-700 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-300 dark:hover:bg-slate-600 transition-all duration-200">
